...
export const en = {
  ...
  portfolio: {
    ...
    project_b1k3: {
      ...
      subtitle: 'Application development, together with its integration with an IoT device, with the purpose of collecting data while using bicycles as a standard form of transport.',
      description: '',
    },
    project_battery: {
    ...
    project_checkaf: {
      ...
      subtitle: 'Precursor of the Check UFPR application, which aimed to be able to map any contact of people with others infected with COVID-19 within the UFPR Curitiba Veterinary Hospital. Project developed during the 2020 pandemic, which was widely accepted by the universitys rectory, and which was later expanded and actively used during the universitys return to school during the years 2021 and 2022.',
      description: '',
    },
    project_comida: {
    ...
    project_portifoliov1: {
      ...
      subtitle: 'Version 1 of the website in question, was designed in order to present the projects developed and also have an e-commerce of websites already developed, but modular, so that there is a sale and a quick implementation for the user.',
      description: '',
    },
    ...
    project_grz: {
      ...
      subtitle: 'Website developed for the company Grupo Risco Zero, in which they had difficulties with mapping and controlling the hours worked by employees. As an automated alternative, a website with a Back-End server was proposed to make all employee entries, as well as the accounting of hours worked and the total amount of payment.',
      description: '',
    },
    project_stocktrade: {
